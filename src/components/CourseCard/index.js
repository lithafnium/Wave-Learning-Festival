...
import { ListContainer, Card, Header, Title, Teachers, Category, CardCompressed, CardExpanded, CourseImage, CourseInfo, Heading, HeaderP, Button} from './styles'
import AnimateHeight from 'react-animate-height'
import WaveLogo from '../../pages/Blog/wave-learning-logo.png'
const CourseCard = ({ title, teachers, category, color, image, description, classDates, classDays, time, targetAudience, courseId }) => {
