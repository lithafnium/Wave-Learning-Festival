    ...
    <>
      ...
      <Container>
        ...
        <Typography.BodyText style={{ color: Colors.WLF_BLACK }}>
          ...
          <b>For now, we are taking donations from residents of Alaska, Arizona, Arkansas, California, Colorado, Connecticut, Delaware, Idaho, Indiana, Iowa, Kansas, Louisiana, Maine, Massachusetts, Minnesota, Montana, New Jersey, New York, Nebraska, North Dakota, Rhode Island, South Dakota, Texas, Vermont, West Virginia, Wisconsin, and Wyoming.</b><br/>
        </Typography.BodyText>
        <Options>
